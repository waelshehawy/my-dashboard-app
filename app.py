...
def get_period_from_date(date_obj):
    """
    تحويل تاريخ إلى اسم الفترة (بنفس الصيغة الموجودة في PERIOD_ORDER)
    """
