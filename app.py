            ...
            if not api_key or api_key == "ضع_مفتاحك_هنا":
                ...
                with st.spinner("🧠 جاري تحليل النص ومطابقة الجداول وسياق الـ ERP..."):
                    try:
                        ...
                        قاعدة صياغة الـ SQL (صارمة وحتمية):
                        - اسم الجدول "حجوزات1" يجب حتماً وقطيعاً وضعه بين علامتي اقتباس مزدوجة ليكون بالشكل التالي دائماً: FROM "حجوزات1" (يُمنع منعاً باتاً كتابته بدون اقتباس كـ FROM حجوزات1 لكي لا تنهار قاعدة بيانات Supabase أو يعود الجدول فارغاً).
                        ...
                        - قم دوماً بجلب هذه الأعمدة الأساسية في الـ SELECT لتعرض بجدول المدير بشكل واضح: "رقم اللوحة", "اسم الزبون", "المحافظة", "الحجم", "فترة الحجز", "اجور عرض".
